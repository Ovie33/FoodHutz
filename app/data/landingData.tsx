...
export const moments = [
  {
    ...
    label: "Hungry Now",
    bgColor: "#fff0ec",
    icon: <IoFlash size={28} color="#e8431a" />,
  },
  {
    id: "quick-lunch",
    label: "Quick Lunch",
    bgColor: "#f0fdf4",
    icon: <MdLunchDining size={28} color="#16a34a" />,
  },
  {
    id: "family-dinner",
    label: "Family Dinner",
  ...
  },
  {
    ...
    label: "Date Night",
    bgColor: "#fff1f2",
    icon: <IoHeart size={28} color="#e11d48" />,
  },
  {
    id: "office-lunch",
    label: "Office Lunch",
    bgColor: "#f0f9ff",
    icon: <HiOfficeBuilding size={28} color="#0ea5e9" />,
  },
  {
    id: "reserve-tonight",
    label: "Reserve Tonight",
    bgColor: "#fffbeb",
    icon: <MdEventAvailable size={28} color="#d97706" />,
  },
  {
    id: "reorder-usual",
    label: "Reorder My Usual",
    bgColor: "#ecfeff",
    icon: <BiRefresh size={28} color="#0891b2" />,
  },
  {
    id: "try-something-new",
    label: "Try Something New Nearby",
    bgColor: "#ecfdf5",
    icon: <IoCompass size={28} color="#059669" />,
  },
];
